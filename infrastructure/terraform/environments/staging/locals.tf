locals {
  common_env_vars = [
    ...
    },
    {
      ...
      value = "${var.environment}-${var.service}-backend-proposal-job"
    },
    {
      name = "VECTOR_DB_USERNAME"
      secret_key_ref = {
        secret  = "${var.environment}-${var.service}-vector-db-username"
        version = "latest"
      }
    },
    {
      ...
      secret_key_ref = {
        secret  = "${var.environment}-${var.service}-vector-db-password"
        version = "latest"
      }
    },
    {
      ...
      secret_key_ref = {
        secret  = "${var.environment}-${var.service}-app-db-username"
        version = "latest"
      }
    },
    {
      ...
      secret_key_ref = {
        secret  = "${var.environment}-${var.service}-app-db-password"
        version = "latest"
      }
    },
    {
    ...
    },
    {
      ...
      secret_key_ref = {
        secret  = "${var.environment}-${var.service}-custom-search-api-key"
        version = "latest"
      }
    },
  ]
